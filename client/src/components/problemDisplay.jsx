      ...
      <div className="flex flex-col justify-center max-w-lg mx-auto px-6 bg-slate-50 drop-shadow-lg border-solid border-2 border-gray-500 rounded-xl h-1/2 w-2/3">
        ...
        {problem ? (
          <form onSubmit={handleProblemSubmit}>
            <div className="my-2">Question Priority: </div>
            ...
            <div className="flex flex-row justify-around mt-6">
              ...
              <button
                key="submitProblem"
                type="submit"
                className="my-2 p-2 break-normal w-1/4 bg-indigo-400 hover:bg-indigo-600 text-white font-bold py-2 px-2 rounded"
              >
                Save
              </button>
            </div>
