  ...
  return (
    <div className="flex flex-col justify-center max-w-lg mx-auto px-6 bg-slate-50 drop-shadow-lg border-solid border-2 border-gray-500 rounded-xl h-1/2 w-2/3">
      ...
      <div className="flex flex-row justify-between my-4">
        ...
        <button className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-2 rounded">Revisit Problems</button>
      </div>
      ...
      <form onSubmit={handleProblemSubmit}>
        ...
        <div className="flex flex-row justify-between">
          <button id="mark-high-prio" onClick={(priority.current = "High")} className="break-normal w-1/4 bg-red-400 hover:bg-red-600 text-white font-bold py-2 px-2 rounded">
            High Priority
          </button>
          <button id="mark-medium-prio" onClick={(priority.current = "Medium")} className="break-normal w-1/4 bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-2 rounded" >
            Medium Priority
          </button>
          <button id="mark-low-prio" onClick={(priority.current = "Low")} className="break-normal w-1/4 bg-green-400 hover:bg-green-600 text-white font-bold py-2 px-2 rounded">
            Low Priority
          </button>
        </div>
        <div className="flex flex-row justify-center">
          ...
          <button type="submit" className="my-2 p-2"> Save Problem </button>
        </div>
      </form>
    </div>
  );
